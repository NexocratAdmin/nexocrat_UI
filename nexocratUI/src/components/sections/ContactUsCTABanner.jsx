...
const ContactUsCTABanner = () => {
  return (
    <section id="contact-us-section" className="py-4 md:py-12 px-4 text-center">
      <div className="flex items-center justify-center max-w-5xl mx-auto rounded-lg border border-[#242424] bg-gray-100 p-4 md:p-12 gap-2 md:gap-10">
        ...
        <Link
          to="/contact"
          className="inline-block bg-[#0f173e] hover:bg-blue-700 text-white font-semibold py-2 md:py-3 px-3 md:px-6 rounded-lg"
        >
          Let's talk
        </Link>
      </div>
